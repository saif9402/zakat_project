...
import 'dart:convert';
import 'gold_calculator_page.dart'; // Ensure this matches the location of your file
...
class _PricesDisplayPageState extends State<PricesDisplayPage> {
  ...
  final String apiKey = 'goldapi-3knmtsltkekj8r-io';
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => GoldCalculatorPage(
